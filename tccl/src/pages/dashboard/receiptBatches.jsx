...
export function ReceiptBatches() {
    ...
    useEffect(() => {
        ...
        axios.get(`${API_URL}/receipts?page=${page}`) // Replace with your actual API endpoint
            .then((response) => {
            ...
            <Card>
                ...
                <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
                    <table className="w-full min-w-[640px] table-auto">
                        <thead>
                            <tr>
                                {["Batch Number", "Number of payments", "Date Created", ""].map((el) => (
                                    <th
                                        key={el}
                            ...
                            {receipts.map((receipt) => {
                                ...
                                return (
                                    <tr key={receipt.batch_no}>
                                        ...
                                        <td className={className}>
                                            <Typography className="text-xs font-semibold text-blue-gray-600">
                                                <Link to={`/dashboard/payments?batch_no=${receipt.batch_no}`}>
                                                    More Details
                                                </Link>
                                            </Typography>
                                        </td>
